...
function PaintingDetails() {
  ...
  const handleAddressSubmit = async (address) => {
    try {
      const response = await axios.post('https://art-core-backend.onrender.com/api/create-order', {
      ...
      const options = {
        ...
        handler: async function (response) {
          await axios.post('https://art-core-backend.onrender.com/api/payment-success', {
