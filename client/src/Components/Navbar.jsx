...
function Navbar() {
    ...
    return (
        <>
            <div className="fixed left-5 top-5 z-[60] h-14 w-14 p-3 font-bold text-black rounded-full bg-navbar transition duration-150 hover:bg-activeTab hover:text-white cursor-pointer" onClick={toggleNavbar}>
                <Bars3Icon />
            </div>


            {/* Navbar */}
            <div className={`select-none fixed flex flex-col items-center justify-around h-full w-[20rem] left-0 bottom-0 bg-navbar z-50 transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
